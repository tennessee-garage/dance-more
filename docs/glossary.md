...
| Term | Meaning |
| --- | --- |
| **Tile** | One square floor section: open 1"×2" wood frame, diagonal brace, 3/8" acrylic top, WS2815 LEDs underneath, driven by an ATtiny3226. 64 total (8×8). |
...
| **Tile controller** | Tier-3 MCU (ATtiny3226) on each tile; drives WS2815 LEDs and listens on the Tile Bus. |
...
| **ATtiny3226** | Microchip AVR MCU used as the tile controller. |
